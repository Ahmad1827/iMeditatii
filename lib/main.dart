import 'dart:ui'; // Pentru BackdropFilter (Glassmorphism)
...
import 'login_screen.dart'; // Presupune ca aveti un LoginScreen
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // Fundal deschis, neutru
        scaffoldBackgroundColor: const Color(0xFFF9FAFB),
        // Schema de culori bazata pe un albastru de brand
...
// -----------------------------------------------------------------------------
// VIDEO CARD (Pastrat functionalitatea de baza)
// -----------------------------------------------------------------------------
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.networkUrl(Uri.parse(widget.url))
      ..initialize().then((_) {
        ...
        // Fallback in caz ca URL-ul e invalid
        print("Eroare la incarcarea video: $error");
...
class _HomePageState extends State<HomePage> {
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          // Blur pentru efectul de sticla
          filter: ImageFilter.blur(sigmaX: 8, sigmaY: 8),
          child: Container(
            padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 10),
            // Opacitate pentru a vedea fundalul
              ...
              children: [
                Row(
                  children: [
                    ...
                    // Nav Links
                    if (isWide) _navText('Proiecte', () => _scrollToSection(_proiecteKey)),
                    if (isWide) _navText('Profesori', () => _scrollToSection(_profesoriKey)),
                    if (isWide) _navText('De ce iMeditatii', () => _scrollToSection(_motivKey)),
                    if (isWide) _navText('Prețuri', () => _scrollToSection(_preturiKey)),
                  ],
                ),
                // Buttons
                Row(
  ...
  Widget _navText(String t, VoidCallback onTap) => Padding(
      ...
      child: isWide
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontSize: 42, fontWeight: FontWeight.w900, color: Colors.grey[900]),
                ),
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      child: const Text('Vezi planurile', style: TextStyle(fontSize: 16)),
                    ),
                  ],
                ),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(16),
                          image: const DecorationImage(
                            image: NetworkImage("http://googleusercontent.com/image_collection/image_retrieval/978914853007179582_0"), // Imaginea cardului
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                      const SizedBox(height: 16),
                      const Text('Exerciții interactive', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 18)),
                      const SizedBox(height: 8),
                      Text('Platforma noastră combină lecțiile live cu exerciții personalizate.', style: TextStyle(color: Colors.grey[600])),
                    ],
                  ),
                ),
              ),
        ...
        children: [
          Text('Meditații online pentru clasele 1–12',
              style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900, color: Colors.grey[900]), textAlign: TextAlign.center),
          const SizedBox(height: 16),
          Text('Exerciții inteligente și meditații personalizate pentru ritmul tău de învățare.',
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              colors: [Color(0xFF3B82F6), Color(0xFF6366F1)], // Albastru la Indigo
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF3B82F6).withOpacity(0.4), // Culoarea umbrei se potrivește cu gradientul
                blurRadius: 8,
  ...
  Widget _ceOferimSection() {
    ...
    final items = [
      {"icon": Icons.school_outlined, "title": "Meditații personalizate", "desc": "Lecții adaptate nivelului și nevoilor tale.", "IconData": Icons.school_outlined},
      {"icon": Icons.people_outline, "title": "Profesori dedicați", "desc": "Mentori cu experiență, pasionați de predare.", "IconData": Icons.people_outline},
      {"icon": Icons.lightbulb_outline, "title": "Exerciții practice", "desc": "Punerea în aplicare a cunoștințelor imediat.", "IconData": Icons.lightbulb_outline},
      {"icon": Icons.auto_graph_outlined, "title": "Evaluări periodice", "desc": "Monitorizarea progresului și feedback constant.", "IconData": Icons.auto_graph_outlined},
      {"icon": Icons.schedule, "title": "Program flexibil", "desc": "Ore seara și weekend-uri, adaptate programului tău.", "IconData": Icons.schedule},
    ];
  ...
  Widget _proiecteStudentiSection() {
    final List<Map<String, String>> proiecte = [
      {"image": "https://i.imgur.com/Wvoh2pk.png", "title": "Flying Cat", "desc": "Joc cu pisici zburatoare."},
      {"image": "https://i.imgur.com/piqaqRU.jpeg", "title": "RockCat", "desc": "Pisica astronauta."},
      {"image": "https://i.imgur.com/vLX6ctE.png", "title": "Kitty Jump", "desc": "Joc saritor."},
      {"image": "https://i.imgur.com/ZOAVEqb.jpeg", "title": "Cat Word Search", "desc": "Joc de cuvinte."},
      {"image": "https://i.imgur.com/B8Aty98.png", "title": "Snake", "desc": "Clasicul Snake."},
    ];
    ...
    return SizedBox(
      ...
      child: Scrollbar( // <--- NOU: Am adăugat Scrollbar-ul
        ...
        child: ListView.builder(
          controller: _proiecteScrollController, // <--- NOU: Am asociat controller-ul
          scrollDirection: Axis.horizontal,
          padding: const EdgeInsets.symmetric(horizontal: 20),
              ...
              child: ClipRRect(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    p.containsKey("video") ? VideoCard(url: p["video"]!) : Image.network(p['image']!, fit: BoxFit.cover),
                    // Gradient Overlay
                    Container(
                      decoration: BoxDecoration(
                    ...
                    Positioned(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(p['title']!, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
    ...
    return SizedBox(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (docs.isEmpty) return const Center(child: Text('Nu există profesori activi încă.'));
          ...
          return Scrollbar( // <--- NOU: Am adăugat Scrollbar-ul
            ...
            radius: const Radius.circular(8),
            child: ListView.builder(
              controller: _profesoriScrollController, // <--- NOU: Am asociat controller-ul
              scrollDirection: Axis.horizontal,
              padding: const EdgeInsets.symmetric(horizontal: 20),
              ...
              itemBuilder: (context, index) {
                ...
                final subject = data['subject'] as String? ?? ''; // Corecție tip
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            child: image.isEmpty ? Icon(Icons.person, size: 50, color: Theme.of(context).colorScheme.primary) : null,
                          ),
                          const SizedBox(height: 16),
                          Text(name, style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 18)),
                          const SizedBox(height: 4),
                          Text(subject, style: TextStyle(color: Theme.of(context).colorScheme.secondary, fontSize: 14)),
  ...
  Widget _preturiSection() {
    final plans = [
      {'name': 'Basic', 'price': '50 RON', 'features': '1 sesiune / săptămână. Resurse limitate.', 'isFeatured': false},
      {'name': 'Standard', 'price': '90 RON', 'features': 'Sesiuni + exerciții adaptate. Suport sporit.', 'isFeatured': true},
      {'name': 'Premium', 'price': '150 RON', 'features': 'Totul + suport dedicat. Acces 24/7 la mentor.', 'isFeatured': false},
    ];
        ...
        children: plans.map((p) {
          ...
          return Expanded(
            child: Container(
              ...
              padding: const EdgeInsets.all(24),
              decoration: BoxDecoration(
                gradient: isFeatured ? const LinearGradient(colors: [Color(0xFF3B82F6), Color(0xFF6366F1)]) : null,
                color: isFeatured ? null : Colors.white,
                borderRadius: BorderRadius.circular(16),
                boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 14, offset: Offset(0, isFeatured ? 10 : 4))],
                border: isFeatured ? null : Border.all(color: Colors.grey.shade200),
              ),
              // SECȚIUNEA CORECTATĂ
// ...
              child: Column(
...
// ..
                  ...
                  ElevatedButton(
                    onPressed: () {},
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isFeatured ? Colors.white : const Color(0xFF3B82F6),
                      foregroundColor: isFeatured ? const Color(0xFF3B82F6) : Colors.white,
                      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                    ),
                    child: Text(isFeatured ? 'Cel mai popular' : 'Alege planul'),
                  ),
                ],
              ),
            ),
        ...
        children: [
          Expanded(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('iMeditatii', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Colors.white)),
                const SizedBox(height: 12),
                Text('Învățăm prin practică și reflecție.', style: TextStyle(color: Colors.white70, fontSize: 16)),
                const SizedBox(height: 24),
                Row(children: const [
                ...
                const SizedBox(height: 40),
                Text('© 2018 - 2025 iMeditatii. All rights reserved.', style: TextStyle(color: Colors.white54, fontSize: 14))
              ],
            ),
          ),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Linkuri Rapide', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 18)),
                const SizedBox(height: 12),
                ...
                Text('Legal', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 18)),
                const SizedBox(height: 12),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(title, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: Color(0xFF1F2937))),
        ],
      ),
    );
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _sectionTitle('Proiectele studenților noștri', key: _proiecteKey),
                    _proiecteStudentiSection(),

                    // PROFESORII NOȘTRI
                    _sectionTitle('Profesorii noștri activi', key: _profesoriKey),
                    _profesoriSection(),
